      ...
      <div className="min-h-dvh flex flex-col p-6 animate-fade-in bg-background">
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <a href="/briefing" className="w-10 h-10 rounded-2xl bg-surface border border-border flex items-center justify-center text-muted hover:text-foreground transition-colors shadow-sm" title="Daily Briefing">
