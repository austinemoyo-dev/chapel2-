      ...
      <div className="w-full max-w-sm space-y-6">
        ...
        {screen === 'login' && (
          <div className="space-y-4">
            ...
            <button
              onClick={() => { setScreen('setup_intro'); setError(''); }}
        ...
        {screen === 'setup_face' && (
          <div className="space-y-4">
            ...
            <button
              onClick={handleSetup}
              disabled={loading || !faceFile || !newPassword || !confirmPw}
              className="w-full h-12 rounded-xl bg-primary text-white font-semibold text-sm disabled:opacity-50"
            >
        ...
        {screen === 'no_face' && (
          <div className="space-y-4 text-center">
            ...
            <p className="text-xs text-muted leading-relaxed">
              Hi <strong>{lookupResult?.full_name}</strong>, your face capture is not complete yet.
              You need to register your face before you can access the portal.
            </p>
            <a
              href={`/registration/face-capture?student=${lookupResult?.student_id}`}
