    ...
    <div className="min-h-dvh bg-background px-4 py-6 space-y-5 max-w-lg mx-auto">
      ...
      {loading ? (
        ...
        <div className="space-y-4">
          ...
          <a
            href="/portal/login"
            onClick={() => { localStorage.removeItem('portal_token'); localStorage.removeItem('portal_student'); }}
            className="block w-full"
          >
            <div className="glass-panel rounded-2xl p-4 border border-border text-center">
              <p className="text-xs text-muted">Reset password via face verification</p>
            </div>
          </a>
